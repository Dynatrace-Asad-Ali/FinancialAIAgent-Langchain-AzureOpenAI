...
def supervisor_agent(apiConfig:APIConfig,news_agent: create_agent, fundamental_agent:create_agent, technical_agent:create_agent) -> create_supervisor:
  ...
  supervisor = create_supervisor(
      ...
      prompt=(
          "You are a supervisor managing three specialized agents. You MUST delegate ALL work to agents — never answer directly.\n\n"
          "AGENTS:\n"
          ...
          "ROUTING RULES:\n"
          "- For ANY stock analysis request (e.g. 'analyze AAPL', 'do stock analysis', 'should I buy MSFT'), "
          "you MUST call news_agent, fundamental_agent, AND technical_agent IN PARALLEL in a single response before doing anything else. "
          "Do not call just one — all three are required.\n"
          ...
          "- Do not answer questions unrelated to finance.\n\n"
          "After all required agents have returned results, synthesize and present a comprehensive response to the user."
      ),
